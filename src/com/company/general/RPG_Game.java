...
public class RPG_Game {
    ...
    public static void startGame() {
        Boss boss = new Boss(2000, 50, "Saurone");
        ...
        Reaper reaper=new Reaper(180,50,"Jnec");
        Thor thor=new Thor(250,40,"Thor");
        Samurai samurai=new Samurai(300,50,"Hanzo");
        Hero[] heroes = {warrior, doc, magic, berserk, assistant,reaper,thor,samurai};
